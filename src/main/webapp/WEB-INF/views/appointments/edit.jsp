                ...
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form:form method="post" action="${contextPath}/appointments/create" modelAttribute="appointment" class="row">
                            ...
                            <form:input class="form-control" type="hidden" path="appointmentID" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <form:select path="clinicID.clinicID" class="form-control">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <button class="btn btn-secondary" type="button" onclick="window.location.href='${contextPath}/appointments/list'">Hủy bỏ</button>
                            </div>
                        </form:form>
                    </div>
                </div>
